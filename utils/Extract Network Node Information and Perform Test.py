...
def out_main():
    for w in range(10, 55, 5):
        for s in range(1, 11):
            ...
            AD_file_path = f'H:/WindowStr/WinDtwPath/Path_cal/MST/network/undirected_results_node/{w}_{s}_AD_undirected_results_node.csv'
            CN_file_path = f'H:/WindowStr/WinDtwPath/Path_cal/MST/network/undirected_results_node/{w}_{s}_CN_undirected_results_node.csv'
            output_file_path = f'H:/WindowStr/WinDtwPath/Path_cal/MST/network/p_undirected_results_node/{w}_{s}_t_test_results.csv'
            main(AD_file_path, CN_file_path,output_file_path)
            print(f"Results for {w}_{s} have been saved to DMN_t_test_results.csv.")
def out_one_main():
    prefix = 'H:/WindowStr/WinDtwPath/Path_cal/'
    AD_file_path = prefix+'/P005/20_8_network/AD_directed_results_node.csv'
    CN_file_path = prefix+'/P005/20_8_network/CN_directed_results_node.csv'
    output_file_path = prefix+'/P005/20_8_network/directed_results_node_results_test.csv'
    main(AD_file_path, CN_file_path,output_file_path)
